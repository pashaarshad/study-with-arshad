                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Enables AI to handle uncertainty and make predictions</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>Essential for neural networks and deep learning</td>
                        </tr>
                        <tr>
...
# Output: Socrates is mortal`}</code></pre>
            </section>
            ...
            <section>
                ...
                <p>Economics contributes important concepts for AI decision-making:</p>
            ...
            <section>
                ...
                <p>Neuroscience studies how the brain works, directly inspiring AI architectures:</p>
            ...
            <section>
                ...
                <p>Psychology helps us understand how humans think, learn, and perceive:</p>

                <ul>
                    <li><strong>Cognitive Psychology</strong> — Studies mental processes like perception, memory, and problem-solving</li>
                    <li><strong>Behaviorism</strong> — Focuses on observable behavior (influenced reinforcement learning)</li>
                    <li><strong>Cognitive Science</strong> — Interdisciplinary study of the mind</li>
                </ul>

                <div className="example-box">
                    <h4>💡 Real-World Connection:</h4>
                    <p>
                        <strong>Reinforcement Learning AI</strong> (like AlphaGo) learns by receiving rewards for good moves
                        and penalties for bad ones—directly inspired by how animals learn through reward and punishment!
                    </p>
                </div>
            </section>
            ...
            <section>
                ...
                <p>Without computers, AI would remain just a theory. Computer engineering provides:</p>

                <ul>
                    <li><strong>Hardware</strong> — Fast processors (CPUs, GPUs, TPUs)</li>
                    <li><strong>Programming Languages</strong> — Python, Lisp, Prolog</li>
                    <li><strong>Data Storage</strong> — Big data storage for training AI</li>
                    <li><strong>Networking</strong> — Cloud computing for distributed processing</li>
                </ul>
            </section>
            ...
            <section>
                ...
                <p>Linguistics is crucial for AI systems that understand and generate human language:</p>
            ...
            <section>
                ...
                <div className="image-placeholder">
                    ...
                    <span>A diagram showing all contributing disciplines to AI</span>
                </div>
            </section>
        ...
        .highlight-box { background-color: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 8px; padding: 1.25rem; margin: 1rem 0; }
        .highlight-box h4 { color: var(--link-color); margin-bottom: 0.75rem; }
        .highlight-box ul { margin-bottom: 0; }
        .example-box { background-color: rgba(34, 197, 94, 0.1); border-left: 4px solid var(--link-color); border-radius: 0 8px 8px 0; padding: 1rem 1.25rem; margin: 1rem 0; }
        .example-box h4 { color: var(--link-color); margin-bottom: 0.5rem; }
        .example-box p { margin-bottom: 0; }
        .comparison-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 1rem 0; }
        .comparison-card { background-color: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 8px; padding: 1.25rem; }
        .comparison-card h4 { color: var(--link-color); margin-bottom: 0.75rem; text-align: center; }
        .comparison-card ul { margin-bottom: 0; }
        ...
        @media (max-width: 640px) { .page-header h1 { font-size: 1.75rem; } .comparison-grid { grid-template-columns: 1fr; } .page-navigation { flex-direction: column; } .page-navigation a { text-align: center; } }
      `}</style>
        </article>
    );
}
